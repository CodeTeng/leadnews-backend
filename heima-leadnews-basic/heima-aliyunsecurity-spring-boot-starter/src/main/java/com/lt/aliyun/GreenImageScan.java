...
import com.lt.aliyun.util.ClientUploader;
import lombok.Data;
...
public class GreenImageScan {
    ...
    public Map imageScan(List<byte[]> imageList) throws Exception {
         ...
         */
        ClientUploader clientUploader = ClientUploader.getFileClientUploader(profile, false);
        String url = null;
